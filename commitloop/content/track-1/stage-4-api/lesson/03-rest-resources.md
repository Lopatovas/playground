...
You need two endpoints to replace Stage 3's mock data (when you wire in Stage 6):

- `GET /workouts` — load the list
- `POST /workouts` — create a record

Test both with curl. Stage 5 swaps what's behind the handlers; the URLs stay the same.
