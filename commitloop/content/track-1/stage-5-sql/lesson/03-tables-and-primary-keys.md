...
Inspect this in DB Browser — **Browse Data** shows the same grid.
...
Run `.schema workouts` in sqlite3 or check the schema view in your GUI after creating the table.
