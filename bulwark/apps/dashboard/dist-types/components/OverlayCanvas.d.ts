...
export declare function OverlayCanvas({ report, artifactsBase, overlay, selectedDefectId, onCurtainChange, onSelectDefect, }: OverlayCanvasProps): import("react").JSX.Element;
